<script lang="ts">
	import { generatePrivateKey, getPublicKey, nip19, finishEvent } from 'nostr-tools';
...
<div class="p-4 w-full">
	...
	<div class="flex flex-wrap p-4 gap-4">
		...
		<div class="flex flex-col gap-2 md:w-6/12 border-2 p-4">
			...
			<textarea class="input input-bordered h-32 p-2">{JSON.stringify(event)}</textarea>
			<span class="divider">or</span>
			<button class="btn btn-primary w-full" on:click={() => getSignedEvent(event)}
				>SignEvent</button
			>
